...
import com.ishan.atmstates.ATMState;
import com.ishan.atmstates.IdleState;

public class ATM {
    private static final ATM ATM_OBJECT = new ATM(); //Singleton: eager initialization
    ...
    public static ATM getATMObject() {
        ATM_OBJECT.setCurrentATMState(new IdleState());
        return ATM_OBJECT;
    }
